...
import { billingAuthSchema, type BillingAuthInput } from "@routinebox/shared";
...
/** 개발 환경 전용: 운영이거나 PAYMENTS_MOCK 이 꺼져 있으면 라우트 자체를 등록하지 않는다. */
if (config.PAYMENTS_MOCK && !isProd) {
